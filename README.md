# 星宝语料场景查询系统 v3.5.0（2026-06-11）

自然语言 → SQL 的医药零售数据查询系统。
技术栈：FastAPI + React + DuckDB + DeepSeek API。
数据量：**1,781,254 行**。数据来源：阿里云 ClickHouse（每天 6:00 增量同步）。
...
| 环境 | 地址 | 端口 | 数据 |
|------|------|------|------|
| 正式 | http://49.232.90.75:8000 | 8000 | 1,781,254 行 |
| 测试 | http://49.232.90.75:8002 | 8002 | 1,781,254 行 |
